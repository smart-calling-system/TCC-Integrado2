      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed:
                controller.exportando ? null : () => _exportar(context),
          ),
        ],
      ),
                          ...
                          Expanded(
                            child: AppCard(
                              child: Column(
                                ...
                                children: [
                                  Text('${controller.totalPresentes}',
                        ...
                        for (final registro in controller.registros)
                          Padding(
                            ...
                            child: AppCard(
                              child: Row(
                                children: [
                                  StudentAvatar(aluno: registro.aluno, size: 40),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment:
