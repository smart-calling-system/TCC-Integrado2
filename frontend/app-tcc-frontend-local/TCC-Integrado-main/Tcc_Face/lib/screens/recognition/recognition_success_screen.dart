...
/// Tela de Sucesso do reconhecimento — dados do aluno identificado e
/// confirmação do registro de entrada.
class RecognitionSuccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Dados enviados pela tela de reconhecimento; em caso de acesso direto
    // usa o aluno padrão mockado.
        ...
        child: Responsive.constrained(
          child: Padding(
            ...
            child: Column(
              children: [
                const Spacer(flex: 2),
                // Ícone de sucesso com animação de escala.
                ...
                Text(
                  'Hoje às ${AppFormatters.horaCompleta(horario)}',
                  style: textTheme.bodyMedium,
                ),
                const SizedBox(height: 32),

                // Cartão com os dados (fictícios) do aluno reconhecido.
                AppCard(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child:
                                _InfoItem(rotulo: 'Turma', valor: aluno.turma),
                          ),
                        ],
                      ),
                    ],
