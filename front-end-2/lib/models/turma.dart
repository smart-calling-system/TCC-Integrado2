...
extension TurnoTurmaBackend on TurnoTurma {
  ...
  static TurnoTurma fromBackend(String? value) {
    switch (value) {
      case 'TARDE':
      case 'tarde':
        return TurnoTurma.tarde;
      case 'NOITE':
      case 'noite':
        return TurnoTurma.noite;
      default:
        return TurnoTurma.manha;
    }
  }
}
...
class Turma {
  ...
  factory Turma.fromJson(Map<String, dynamic> json) => Turma(
    ...
    turno: TurnoTurmaBackend.fromBackend(json['turno'] as String?),
  ...
  Map<String, dynamic> toJson() => {
    'id': id,
    'nome': nome,
    'anoLetivo': int.tryParse(serie),
    'turno': turno.backendValue,
    'sala': sala,
