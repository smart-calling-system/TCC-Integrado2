...
class _SyncView extends StatelessWidget {
  ...
  Future<void> _sincronizar(BuildContext context) async {
    final sucesso = await context.read<SyncController>().sincronizar();
    if (context.mounted) {
      final controller = context.read<SyncController>();
      final mensagem =
          controller.mensagem ??
          (sucesso
              ? AppStrings.sincronizacaoConcluida
                ...
                child: ListView(
                  ...
                  children: [
                          ...
                          TweenAnimationBuilder<double>(
                            ...
                            builder: (context, valor, _) => Text(
                              ...
                              style: textTheme.headlineMedium?.copyWith(
                                fontSize: 56,
                                color: controller.status!.registrosPendentes > 0
                                    ? AppColors.warning
                                    : AppColors.success,
                              ),
                            ),
                    ...
                    AppButton(
                      ...
                      onPressed: controller.sincronizando
                          ? null
