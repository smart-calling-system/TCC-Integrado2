...
class _AlunoListView extends StatelessWidget {
  ...
  Future<void> _remover(BuildContext context, Aluno aluno) async {
    final confirmou = await AppDialog.confirmar(
      ...
      mensagem:
          'Deseja realmente excluir "${aluno.nome}"? Esta ação não '
          'pode ser desfeita.',
  ...
  Future<void> _abrirFormulario(BuildContext context, {Aluno? aluno}) async {
    final salvou = await Navigator.of(
      context,
    ).pushNamed(AppRoutes.alunoForm, arguments: aluno);
              ...
              Expanded(
                child: controller.carregando
                    ...
                    ? _TabelaAlunos(
                        ...
                        onEditar: (a) => _abrirFormulario(context, aluno: a),
