                ...
                children: [
                  SizedBox(
                    ...
                    child: const EmptyState(
                      mensagem: AppStrings.nenhumRegistro,
                    ),
                  ),
                ],
              ),
      ...
      child: Row(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(rotulo, style: textTheme.bodySmall?.copyWith(fontSize: 11)),
              Text(valor, style: textTheme.titleMedium?.copyWith(fontSize: 14)),
            ],
          ),
        ],
      ),
