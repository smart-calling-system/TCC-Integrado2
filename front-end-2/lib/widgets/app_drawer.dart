...
const List<_DrawerItem> _itens = [
  ...
  _DrawerItem(
    ...
    AppStrings.disciplinas,
    AppRoutes.disciplinas,
  ),
  _DrawerItem(
    Icons.event_available_outlined,
    AppStrings.presencas,
    AppRoutes.historico,
  ),
  _DrawerItem(
    Icons.face_outlined,
    AppStrings.reconhecimentoFacial,
    AppRoutes.reconhecimento,
  ),
  _DrawerItem(
    Icons.bar_chart_outlined,
    AppStrings.relatorios,
    AppRoutes.relatorios,
  ),
  _DrawerItem(
    Icons.sync_outlined,
    AppStrings.sincronizacao,
    AppRoutes.sincronizacao,
  ),
];
              ...
              child: ListView(
                ...
                children: [
                  for (final item in _itens)
                    _Tile(item: item, selecionado: rotaAtual == item.rota),
                ],
              ),
            ),
